...
if (form) {
  ...
  let name = idInput("form_name"),
    tel = idInput("form_tel"),
    email = idInput("form_email"),
    message = idInput("form_consulta");
